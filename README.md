...
* **Security Tools:** Kali Linux, Burp Suite, WebDAV Exploitation, Apache Tomcat (JSP Web Shells), Advanced Nmap & NSE Scripts, SMB/Telnet/FTP Auditing, Hash Cracking, Privilege Escalation, File Upload Bypass
