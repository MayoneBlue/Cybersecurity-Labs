...
* **Practice Labs:** Standalone Capture The Flag (CTF) environments to practice manual system exploitation, authentication bypass, remote code execution, and privilege escalation.
...
* **Security Tools:** Kali Linux, Burp Suite Pro/Community, Authentication Bypass, Remote Code Execution (RCE), AWS S3 Enumeration, SQL Injection, OS Command Injection, Nmap, Directory Fuzzing (Gobuster/Dirb)
* **Access Level:** TryHackMe Premium 💎

---

### 📈 Stats & Progress
* **Total Journey Streak:** 73 Days 🔥
* **TryHackMe Platform Streak:** 72 Days 🏆
