...
* **Practice Labs:** Standalone Capture The Flag (CTF) environments to practice manual system exploitation and privilege escalation.
...
* **Security Tools:** Kali Linux, Burp Suite Pro/Community, SQL Injection, OS Command Injection, Nmap, Network Protocol Analysis, Directory Fuzzing (Gobuster/Dirb)
* **Access Level:** TryHackMe Premium 💎

---

### 📈 Stats & Progress
* **Total Journey Streak:** 71 Days 🔥
* **TryHackMe Platform Streak:** 70 Days 🏆
* **Current League:** Sapphire league (148 points) 🥈
