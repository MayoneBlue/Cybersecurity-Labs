...
* **Practice Labs:** Standalone Capture The Flag (CTF) environments to practice manual system exploitation, remote code execution, and privilege escalation.
...
* **Security Tools:** Kali Linux, Burp Suite Pro/Community, Remote Code Execution (RCE), AWS S3 Enumeration, SQL Injection, OS Command Injection, Nmap, Directory Fuzzing (Gobuster/Dirb)
* **Access Level:** TryHackMe Premium 💎

---

### 📈 Stats & Progress
* **Total Journey Streak:** 72 Days 🔥
* **TryHackMe Platform Streak:** 71 Days 🏆
* **Current League:** Sapphire (Rank #17) 💎
